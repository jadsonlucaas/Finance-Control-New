export const MAIN_TABS = ['dashboard', 'saidas', 'entradas', 'importacao', 'controle-horas', 'configuracoes'];
...
export const APP_VIEWS = ['dashboard', 'mes-detalhe', 'saidas', 'entradas', 'importacao', 'controle-horas', 'novo', 'configuracoes'];
